...
workfile = ''.join((savefolder, '-xenolithEquilibration_3mm_logD14.txt'))
...
ax.text(200, 90, labels[2], rotation=3)
ax.text(400, 60, labels[3], rotation=10)
ax.text(600, 20, labels[4], rotation=10)
ax.text(700, 2, labels[5], rotation=10)

#ax.text(0.05, 97, '~olivine', rotation=30)
#ax.text(10., 80, '~clinopyroxene', rotation=25)


plt.savefig('C:\\Users\\Ferriss\\Documents\\CpxPaper\\xenolithEquilibration_3mm_logD14.png', dpi=150)
