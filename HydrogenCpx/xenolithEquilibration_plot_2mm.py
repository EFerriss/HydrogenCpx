...
workfile = ''.join((savefolder, '-xenolithEquilibration_2mm.txt'))
...
ax.text(17, 86, labels[3], rotation=10)
ax.text(20, 60, labels[4], rotation=10)
ax.text(21, 35, labels[5], rotation=10)

ax.text(0.05, 97, '~olivine', rotation=30)
ax.text(10., 80, '~clinopyroxene', rotation=25)


plt.savefig('C:\\Users\\Ferriss\\Documents\\CpxPaper\\xenolithEquilibration_2mm.png', dpi=150)
