...
This version is altered to use IV-Al concentrations calculated the same
way as O'Leary et al. 2010, so IV-Al = 0.5 * (total Al - Na)
"""
...
ax.add_patch(fbox)
ax.text(xenoMin, xenoDmin, '~mantle cpx', ha='left', va='bottom',
        rotation=0.)
